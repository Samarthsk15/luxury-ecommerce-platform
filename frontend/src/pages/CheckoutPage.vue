            ...
            <div class="payment-accordion">
              ...
              <div class="payment-option" :class="{ 'selected': selectedPayment === 'upi' }" @click="selectedPayment = 'upi'">
                <div class="option-header">
                  ...
                  <span class="option-label">UPI (Google Pay, PhonePe, Paytm)</span>
              ...
              <div class="payment-option" :class="{ 'selected': selectedPayment === 'card' }" @click="selectedPayment = 'card'">
                <div class="option-header">
                  <div class="radio-circle"></div>
                  <span class="option-label">Credit / Debit / ATM Card</span>
                  <span class="option-icons">💳</span>
                </div>
...
const placeOrder = () => {
  ...
  setTimeout(() => {
    alert(`🎉 Order successfully placed via ${selectedPayment.value.toUpperCase()}! Redirecting to home...`);
    cart.clearCart();
    router.push('/');
  }, 2000);
};
