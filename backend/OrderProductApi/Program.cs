...
using OrderProductApi.Middleware;
...
var stripeSecretKey = builder.Configuration["Stripe:SecretKey"] ?? "sk_test_placeholder_key_replace_me";
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:8080", "http://localhost:5173", "http://localhost:5174", "http://localhost:3000", "http://127.0.0.1:8080")
            .AllowAnyHeader()
            .AllowAnyMethod()
            .AllowCredentials();
    });
